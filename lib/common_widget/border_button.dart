...
class BorderButton extends StatelessWidget {
  ...
  const BorderButton({Key? key, required this.title, this.type = BorderButtonType.active, required this.onPressed})
      : super(key: key);
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: TextStyle(
            color: type == BorderButtonType.active ? TColor.primary : TColor.secondaryText,
            fontSize: 20,
